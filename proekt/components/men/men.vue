...
<div class="men">
    ...
    <div class="men-filters-inputs">
      ...
      <span>От</span>
      <input type="text" name="menUnder" id="" @blur="menPrice" v-model.number="menUnder" placeholder="0">
      <span>До</span>
      <input type="text" name="menUp" id="" @blur="menPrice" v-model.number="menUp" placeholder="10000">
    </div>
